...
export const TARIFA_FAQ_ITEMS = [
  {
    question: "O que é TE?",
    answer:
      "TE é a Tarifa de Energia, que remunera a eletricidade produzida e comercializada no mercado.",
  },
  {
    question: "O que é TUSD?",
    answer:
      "TUSD é a Tarifa de Uso do Sistema de Distribuição, referente ao transporte da energia até o consumidor.",
  },
  {
    question: "O que é ICMS na conta de luz?",
    answer:
      "ICMS é o imposto estadual calculado sobre o consumo de energia elétrica.",
  },
  {
    question: "Como economizar energia?",
    answer:
      "Reduza desperdícios, troque equipamentos por modelos eficientes, ajuste hábitos de consumo e avalie fontes alternativas como a energia solar.",
  },
  {
    question: "Vale a pena instalar energia solar?",
    answer:
      "Para muitos consumidores, sim. O payback costuma ocorrer entre 3 e 6 anos, com economia significativa ao longo da vida útil do sistema.",
  },
];
